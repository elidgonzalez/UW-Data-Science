...
-- filter rdfabout.com
filtered_triples = FILTER ntriples BY subject matches '.*business.*';
...
-- join
joined_triples = JOIN filtered_triples BY subject, filtered_triples_2 BY subject2;
...
store results into '/user/hadoop/problem3a-results' using PigStorage();
